...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "capture_profile": {
        "zh-CN": "采集策略：{strategy}  · 稳定性：{stability}\n候选组合：{candidates}",
        "en": "Capture strategy: {strategy}  · Stability: {stability}\nCandidates: {candidates}",
    },
    "stability_high": {"zh-CN": "高", "en": "High"},
    "stability_medium": {"zh-CN": "中", "en": "Medium"},
    "stability_low": {"zh-CN": "低", "en": "Low"},
    "strategy_automation_id": {"zh-CN": "AutomationId 优先", "en": "AutomationId first"},
    "strategy_name_prefix": {"zh-CN": "动态名称前缀 + 类型", "en": "Dynamic name prefix + type"},
    "strategy_name": {"zh-CN": "名称 + 类型", "en": "Name + type"},
    "strategy_structure": {"zh-CN": "结构属性组合", "en": "Structural properties"},
    "validation_matches": {
        "zh-CN": "已找到 {count} 个匹配，已高亮最佳匹配：{name}",
        "en": "Found {count} match(es); highlighted the best match: {name}",
    },
    "validation_failure_detail": {
        "zh-CN": "验证失败（{stage}）：{message}",
        "en": "Validation failed ({stage}): {message}",
    },
